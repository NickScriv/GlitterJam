	...
	public class wwise
	{
		...
		public class core
		{
			...
			public class @object
			{
				...
				/// <summary>Performs a query and returns specified data for each object in the query result. The query can specify either a 'waql' argument or a 'from' argument with an optional 'transform' argument. Refer to \ref waql_introduction or \ref waapi_query for more information.</summary>
