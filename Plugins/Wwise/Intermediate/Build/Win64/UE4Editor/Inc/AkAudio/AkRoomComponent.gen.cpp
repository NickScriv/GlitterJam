...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkRoomComponent_Statics::NewProp_bEnable_MetaData[] = {
		{ "Category", "Toggle" },
		{ "Comment", "/** Enable room transmission feature, additional properties are available in the Room category. */" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkRoomComponent_Statics::NewProp_bDynamic_MetaData[] = {
		{ "Category", "Room" },
		{ "Comment", "/** If true, the portal connections for this room can change during runtime when this room moves. For worlds containing many portals, this can be expensive. Note that this room's portal connections may still change, even when bDynamic = false, when dynamic portals are moved (i.e. when portals move who have bDynamic = true). */" },
		{ "DisplayName", "Is Dynamic" },
		{ "ModuleRelativePath", "Classes/AkRoomComponent.h" },
		{ "ToolTip", "If true, the portal connections for this room can change during runtime when this room moves. For worlds containing many portals, this can be expensive. Note that this room's portal connections may still change, even when bDynamic = false, when dynamic portals are moved (i.e. when portals move who have bDynamic = true)." },
	};
#endif
	...
	IMPLEMENT_CLASS(UAkRoomComponent, 2084201393);
