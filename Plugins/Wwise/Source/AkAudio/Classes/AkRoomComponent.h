...
class AKAUDIO_API UAkRoomComponent : public UAkGameObject
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Room", meta = (DisplayName = "Is Dynamic"))
	bool bDynamic = false;
	...
	*/
	...
	/**
	* Used to set the transmission loss value in wwise, on emitters in the room, when no audio paths to the listener are found via sound propagation in Wwise Spatial Audio.
	...
	*/
	...
	bool RoomIsActive() const { return Parent && bEnable && !IsRunningCommandlet(); }
