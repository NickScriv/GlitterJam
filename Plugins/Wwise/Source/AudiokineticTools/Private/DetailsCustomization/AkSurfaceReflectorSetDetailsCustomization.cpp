...
void FAkSurfaceReflectorSetDetailsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	DetailLayout.EditCategory("Surfaces & Geometry", FText::GetEmpty(), ECategoryPriority::TypeSpecific);
	...
	IDetailCategoryBuilder& CategoryBuilder = DetailLayout.EditCategory("Surfaces & Geometry");
